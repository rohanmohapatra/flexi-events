...
create table events( event_id uuid, event_title text, event_description text, keywords list<text>, start_date timestamp, end_date timestamp, event_link text, email text, PRIMARY KEY(email, event_id));
